...
Aquí veremos a detalle el funcionamiento de RSA, aplicaremos gran parte de lo que hemos visto en los capítulos anteriores, también dejaremos un código en Mathematica que automatiza el algoritmo en nuestra página web (link en el perfil o en los comentarios)
...
Finalmente esta instrucción lo descifra y listo. 